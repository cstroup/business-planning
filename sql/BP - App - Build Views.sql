...
CREATE VIEW [dbo].[vw_reporting_forecast_full] AS
...
CREATE VIEW [dbo].[vw_reporting_forecast_line_items] AS

SELECT
	fli.forecast_id as [Forecast ID],
	dd.full_date as [Date],
	dd.short_month_short_year as [Month/Year],
	fli.amount as [Amount],
	fli.forecast as [Forecast],
	fli.budget as [Budget],
	fli.q1f as [Q1F],
	fli.q2f as [Q2F],
	fli.q3f as [Q3F],
