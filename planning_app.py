...
class App:
    ...
    def create_tagger_tab_tables(self):
        ...
        # Start Date
        self.start_date_label = tk.Label(self.tab1_top_frame_filters, text="Start Date:", bg='#DCDAD5')
        ...
        self.start_dropdown_gl = ttk.Combobox(self.tab1_top_frame_filters, textvariable=self.selected_gl_start_date,
        ...
        # End Date
        self.end_date_label = tk.Label(self.tab1_top_frame_filters, text="End Date:", bg='#DCDAD5')
        ...
        self.end_dropdown_gl = ttk.Combobox(self.tab1_top_frame_filters, textvariable=self.selected_gl_end_date,
        ...
        # Account Number
        self.account_number_label = tk.Label(self.tab1_top_frame_filters, text="Account Code:", bg='#DCDAD5')
        self.account_number_label.pack(side="left", padx=(10, 5), pady=5,)
        self.account_number_input = tk.Entry(self.tab1_top_frame_filters, width=20)
        self.account_number_input.pack(side="left", padx=(5, 15), pady=5,)
        self.filter_acct_number = self.account_number_input.get()
        
        # Purchase Order #
        self.purchase_order_label = tk.Label(self.tab1_top_frame_filters, text="Purchase Order #:", bg='#DCDAD5')
        self.purchase_order_label.pack(side="left", padx=(10, 5), pady=5,)
        self.purchase_order_input = tk.Entry(self.tab1_top_frame_filters, width=20)
        self.purchase_order_input.pack(side="left", padx=(5, 15), pady=5,)
        self.filter_po_number = self.purchase_order_input.get()
        
        # Department Code
        self.department_code_label = tk.Label(self.tab1_top_frame_filters, text="Department Code:", bg='#DCDAD5')
        self.department_code_label.pack(side="left", padx=(10, 5), pady=5,)
        self.department_code_input = tk.Entry(self.tab1_top_frame_filters, width=20)
        self.department_code_input.pack(side="left", padx=(5, 15), pady=5,)
    ...
    def create_gl_table_tab_1(self):
        ...
        self.dtype_dict_gl = {
            'int': ['GL ID', 'Forecast ID', 'Auto Tagger ID', 'Assignment Ref', 'Account Code', 
    ...
    def create_full_forecast_table(self):
        ...
        # Department Code
        self.department_code_label_frcst = tk.Label(self.tab_3_filter_frame, text="Department Code:", bg='#DCDAD5', width=label_width, anchor='e')
        ...
        # Account Number
        self.account_number_label_frcst = tk.Label(self.tab_3_filter_frame, text="Account Code:", bg='#DCDAD5', width=label_width, anchor='e')
        ...
        # Main Document Title
        self.mdt_label_frcst = tk.Label(self.tab_3_filter_frame, text="Main Doc Title:", bg='#DCDAD5', width=label_width, anchor='e')
        ...
        # Supplier
        self.supplier_label_frcst = tk.Label(self.tab_3_filter_frame, text="Supplier:", bg='#DCDAD5', width=label_width, anchor='e')
        ...
        # Description
        self.desc_label_frcst = tk.Label(self.tab_3_filter_frame, text="Description:", bg='#DCDAD5', width=label_width, anchor='e')
        ...
        # PO Number
        self.po_label_frcst = tk.Label(self.tab_3_filter_frame, text="PO Number:", bg='#DCDAD5', width=label_width, anchor='e')
    ...
    def create_work_order_detail_labels(self):
        ...
        self.tab_4_bottom_left_top_half_frame.pack(side='top', pady=5, fill='x', expand=False)
    ...
    def create_admin_portal(self):
        ...
        tk.Label(self.admin_frame, text="Server Name:", anchor='w', bg='#DCDAD5').grid(row=0, column=0, columnspan=2, padx=5, pady=5, sticky='w')
